    ...
    <div className="flex ">
        ...
        <div className="w-72 border-r border-slate-300 min-h-screen mr-4  pt-28">
            ...
            <SidebarItem href={"/home"} icon={<HomeIcon/>} title="Home" />
                <SidebarItem href={"/wallet"} icon={<TransferIcon />} title="Wallet Transfer" />
                <SidebarItem href={"/P2P"} icon={<P2PTransferIcon />} title="Transfer Funds" />
                <SidebarItem href={"/P2P-test"} icon={<P2PTransferIcon />} title="Transfer Funds test" />
                <SidebarItem href={"/wallet-transaction"} icon={<TransactionsIcon />} title="Wallet Transaction" />
                <SidebarItem href={"/transfer-transactions"} icon={<TransferTransaction />} title="Transfer Transaction" />
            </div>
        </div>
            {children}
    </div>
